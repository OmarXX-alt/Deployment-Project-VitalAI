...
def create_hydration_log(
    user_id: ObjectId,
    amount_ml: int | float,
    daily_total_ml: int | float,
    logged_at: datetime | None = None,
    ai_reaction: dict[str, object] | None = None,
) -> dict[str, object]:
    """
    Create a hydration log document ready for MongoDB insertion.

    Parameters:
        user_id: MongoDB ObjectId of the user.
        amount_ml: Hydration amount logged in milliliters.
        daily_total_ml: Running daily total in milliliters.
    ...
    amount_value = _require_number(amount_ml, "amount_ml")
    total_value = _require_number(daily_total_ml, "daily_total_ml")
